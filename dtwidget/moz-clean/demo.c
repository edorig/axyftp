...
int main(int argc, char* argv[]){
  ...
  XtAddCallback(mainwin,XmNactivateCallback,activate_cb,NULL);
  XtAddCallback(mainwin,XmNselectionCallback,select_cb,NULL);
  XtAddCallback(mainwin,XmNfocusCallback,focus_cb,NULL);
  XtAddCallback(mainwin,XmNlosingFocusCallback,losing_cb,NULL);
  XtAddCallback(mainwin,XmNmenuPostCallback,menu_cb,NULL);
