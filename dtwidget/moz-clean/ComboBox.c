...
static void	ClassInitialize AA((void));
...
static XtResource resources[] = {
    ...
    {XmNverticalSpacing, XmCVerticalSpacing, XmRVerticalDimension,
	 ...
	 XmRImmediate, (XtPointer)INVALID_DIMENSION},
    {XmNmoveSelectedItemUp, XmCMoveSelectedItemUp, XmRBoolean, 
         sizeof(Boolean), offset(combo_box.move_selecteditem_up),
	 XmRImmediate, (XtPointer)FALSE},
    {XmNnoCallbackForArrow, XmCNoCallbackForArrow, XmRBoolean,
      sizeof(Boolean), offset(combo_box.no_callback_for_arrow),
      XmRImmediate, (XtPointer)FALSE},
};
...
XtPointer call_data;
{
     ...
     */
    if (((XmListWidget)combo_p->list)->list.items<=0)
	return;
...
void
DtComboBoxSelectItemMoveup(DtComboBoxWidget combo, XmString item)
{
    DtComboBoxPart *combo_p = (DtComboBoxPart*)&(combo->combo_box);
    XmStringTable list_items = ((XmListWidget)combo_p->list)->list.items;
    int i;
